...
<html lang="en">
    <head>
      ...
      <title>Kindergarten Enrollment | San Francisco De Sales</title>
    </head>
    ...
    <body>
        ...
        <main>
            ...
            <div class="container">
                ...
                <h1 class="display-1 fw-bold text-capitalize text-light mb-3">Kindergarten</h1>
                <br>
            </div>

            <div class="container form-body p-5">
                <h2 class="fw-bold text-muted">Enrollment Form - Kindergarten</h2>
                <p class="fw-med text-muted">School Year 2023-2024</p>
                <br><br>
                <p class="fw-med text-success">Student Information</p><hr>
                
                <!-- FORM CONTROL -->
                <form class="row g-4 fw-med" action="db-conn-kdg.php" method="post">
                <div class="col-md-6">
                    <label for="lastName" class="form-label">Last Name</label>
                    <input type="text" name="lastName" class="form-control" id="input" required>
                </div>
                <div class="col-md-6">
                ...
                <form class="row g-4 fw-med">
                    ...
                    <div class="col-12">
                    <button class="btn btn-success px-5 py-2 fs-5 mt-5 fw-med" type="submit">Submit</button>
                    </div>
                </form>
            </section>
        </main>
